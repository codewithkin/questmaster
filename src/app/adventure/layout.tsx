export const metadata = {
    ...
    description: "Continue your adventure, make choices, and shape the outcome of your journey.",
    keywords: "adventure game, choice-based game, text adventure, role-playing",
    openGraph: {
      title: "Adventure Mode - Choose Your Story",
      description: "Dive into an interactive adventure where every choice matters!",
      type: "website",
